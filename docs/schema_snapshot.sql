...
\restrict 8ugvBr4fhivHIK4J0nk9Cpd4CcwRZuJSn6IJp7HUjvGojd8nPdqIrUBlVI3mg7j
...
CREATE TABLE public.consent_events (
    ...
    tenant_id uuid NOT NULL,
    old_status public.consent_status NOT NULL,
...
--
-- Name: idempotency_keys uq_idempotency_request_id; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.idempotency_keys
    ADD CONSTRAINT uq_idempotency_request_id UNIQUE (request_id);
...
ALTER TABLE ONLY public.idempotency_keys
    ADD CONSTRAINT idempotency_keys_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
\unrestrict 8ugvBr4fhivHIK4J0nk9Cpd4CcwRZuJSn6IJp7HUjvGojd8nPdqIrUBlVI3mg7j
